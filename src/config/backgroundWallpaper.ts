...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/skadi-desktop-01.jpg",
			"assets/images/DesktopWallpaper/skadi-desktop-02.jpg",
			"assets/images/DesktopWallpaper/skadi-desktop-03.jpg",
			"assets/images/DesktopWallpaper/skadi-desktop-04.jpg",
			"assets/images/DesktopWallpaper/skadi-desktop-05.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/skadi-mobile-01.jpg",
			"assets/images/MobileWallpaper/skadi-mobile-02.jpg",
			"assets/images/MobileWallpaper/skadi-mobile-03.jpg",
			"assets/images/MobileWallpaper/skadi-mobile-04.jpg",
			"assets/images/MobileWallpaper/skadi-mobile-05.jpg",
			"assets/images/MobileWallpaper/skadi-mobile-06.jpg",
		],
		// 背景视频播放地址
