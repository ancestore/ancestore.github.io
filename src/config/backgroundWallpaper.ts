...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/skadi-desktop-01.webp",
			"assets/images/DesktopWallpaper/skadi-desktop-02.webp",
			"assets/images/DesktopWallpaper/skadi-desktop-03.webp",
			"assets/images/DesktopWallpaper/skadi-desktop-04.webp",
			"assets/images/DesktopWallpaper/skadi-desktop-05.webp",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/skadi-mobile-01.webp",
			"assets/images/MobileWallpaper/skadi-mobile-02.webp",
			"assets/images/MobileWallpaper/skadi-mobile-03.webp",
			"assets/images/MobileWallpaper/skadi-mobile-04.webp",
			"assets/images/MobileWallpaper/skadi-mobile-05.webp",
			"assets/images/MobileWallpaper/skadi-mobile-06.webp",
		],
		// 背景视频播放地址
